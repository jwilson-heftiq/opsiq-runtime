-- DDL for gold_decision_evidence_operational_risk_v1 table
...
ALTER TABLE gold_decision_evidence_operational_risk_v1
ADD CONSTRAINT pk_evidence
PRIMARY KEY (tenant_id, subject_type, subject_id, primitive_name, primitive_version, as_of_ts, evidence_id);

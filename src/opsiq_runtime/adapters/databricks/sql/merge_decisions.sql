-- MERGE INTO template for decision outputs
...
USING (
    SELECT
        ...
        :decision_state AS decision_state,
        :confidence AS confidence,
        :drivers_json AS drivers_json,
        :metrics_json AS metrics_json,

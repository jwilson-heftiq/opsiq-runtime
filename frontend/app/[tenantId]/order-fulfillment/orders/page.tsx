...
import { OrdersWorklistClient } from "./OrdersWorklistClient"
import { fetchOrdersWorklist } from "@/lib/api/orderFulfillment.server"
...
async function WorklistServer({
  ...
  try {
    const data = await fetchOrdersWorklist(tenantId, {
      state: initialState,
...
export default async function OrdersAtRiskPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Orders at Risk</h1>
